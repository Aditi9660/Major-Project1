...
public class SignUpController {
    ...
    public String TrackingDetails(@RequestParam("TrackingNo") String TrackingNo, Model model){
        TrackingDTO trackingDTO = packageService.getByTrackingNo(TrackingNo);

        if(trackingDTO == null){
            model.addAttribute("errormessage","Tracking No. not found please try again");
            return "home";
        }
